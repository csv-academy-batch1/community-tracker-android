...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginViewModel.loginPasswordForm.observe(this@LoginActivity, Observer {
        ...
        etUsername.afterTextChanged {
            ...
            loginViewModel.usernameDataChanged(etUsername.text.toString())
        }
